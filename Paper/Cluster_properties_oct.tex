...
\begin{figure}[ht!]
   \begin{center}$
      \begin{array}{cc}
         \includegraphics[trim=3.4cm 0.2cm 0.2cm 0.2cm, clip=True, scale=0.5]{figs/cluster_catalog_footprint.pdf} 
      \end{array}$
   \end{center}
...
\begin{figure*}[!htbp]
\centering
\mbox{\subfigure{\includegraphics[trim=5cm 5cm 5cm 5cm, clip=True, scale=0.6]{figs/ap81_rad.pdf} 
\includegraphics[trim=6cm 5cm 5cm 5cm, clip=True, scale=0.6]{figs/ap71_rad.pdf}}}
...
\begin{figure*}[!htbp]
\centering
\mbox{\subfigure{\includegraphics[trim=5cm 4cm 4cm 4cm, clip=True, scale=0.6]{figs/ap2023_compmag1.pdf} 
\includegraphics[trim=6cm 5cm 4cm 4cm, clip=True, scale=0.6]{figs/ap2023_compmag2.pdf}}}
...
\begin{figure*}[!htbp]
\centering
\mbox{\subfigure{\includegraphics[trim=0.6cm 0.5cm 1.5cm 1cm, clip=True, scale=0.4]{figs/ap2023_cmdonly_orig.pdf} 
\includegraphics[trim=0.6cm 0.5cm 1.5cm 1cm, clip=True, scale=0.4]{figs/ap2023_cmdonly_SB.pdf}}}
...
\begin{figure*}[!htbp]
   \begin{center}$
      \begin{array}{cc}
         \includegraphics[trim=2.6cm 0.2cm 0.2cm 0cm, clip=True, width=7.8in]{figs/syn_results528.pdf} 
      \end{array}$
   \end{center}
...
\begin{figure*}[!htbp]
   \begin{center}$
     \begin{array}{cc}
        \includegraphics[trim=0cm 11cm 0cm 0cm, clip=True, width=7in]{figs/delta1008.pdf} 
    \end{array}$
 \end{center}
...
\begin{figure}[ht!]
   \begin{center}$
     \begin{array}{cc}
        \includegraphics[trim=3.1cm 8.2cm 3.8cm 0.2cm, clip=True, scale=0.65]{figs/ap3219_test.pdf} 
    \end{array}$
 \end{center}
...
\begin{figure*}[!htbp]
   \begin{center}$
     \begin{array}{cc}
        \includegraphics[trim=1cm 4cm 0.2cm 0.2cm, clip=True, scale=0.5]{figs/int_uncertainties.pdf} 
    \end{array}$
 \end{center}
...
\begin{figure}[ht!]
   \begin{center}$
     \begin{array}{cc}
        \includegraphics[trim=2.9cm 8.2cm 3.8cm 0.2cm, clip=True, scale=0.65]{figs/ap3320_test.pdf} 
    \end{array}$
 \end{center}
...
\begin{figure*}[!htbp]
\centering
\mbox{\subfigure{\includegraphics[trim=0.7cm 0.1cm 2.5cm 0.2cm, clip=True, scale=0.45]{figs/plot_int_match_age.pdf} 
\includegraphics[trim=0.7cm 0.1cm 2.5cm 0.2cm, clip=True, scale=0.45]{figs/plot_int_match_mass.pdf}}}
\\
\mbox{\subfigure{\includegraphics[trim=0.7cm 0.1cm 2.5cm 0.2cm, clip=True, scale=0.45]{figs/plot_int_match_av.pdf}}}
...
\begin{figure}[ht!]
   \begin{center}$
      \begin{array}{cc}
         \includegraphics[trim=0.1cm 0.1cm 0.1cm 0.1cm, clip=True, scale=0.45]{figs/age_unres475.pdf} 
      \end{array}$
   \end{center}
...
\begin{figure}[!ht]
   \begin{center}$
      \begin{array}{cc}
         \includegraphics[trim=4cm 1cm 1cm 0.5cm, clip=True, scale=0.5]{figs/plot_cmd_hist1.pdf} 
      \end{array}$
   \end{center}
...
\begin{figure}[ht!]
   \begin{center}$
      \begin{array}{cc}
         \includegraphics[trim=3.2cm 0.8cm 0.2cm 0.2cm, clip=True, scale=0.45]{figs/hist_flag611.pdf} 
      \end{array}$
   \end{center}
...
\begin{figure}[ht!]
   \begin{center}$
      \begin{array}{cc}
         \includegraphics[trim=3.2cm 0.8cm 0.2cm 0.2cm, clip=True, scale=0.45]{figs/plot_flag_ndet.pdf} 
      \end{array}$
   \end{center}
...
\begin{figure}[!ht]
   \begin{center}$
      \begin{array}{cc}
         \includegraphics[trim=3cm 1cm 1cm 0.5cm, clip=True, scale=0.5]{figs/age_mass_comp1018.pdf} 
      \end{array}$
   \end{center}
...
\begin{figure}[ht!]
   \begin{center}$
      \begin{array}{cc}
         \includegraphics[trim=3.1cm 0.2cm 3cm 1.5cm, clip=True, scale=0.48]{figs/cluster_catalog63.pdf} 
      \end{array}$
   \end{center}
...
\begin{figure}[ht!]
   \begin{center}$
      \begin{array}{cc}
         \includegraphics[trim=2.7cm 0.2cm 3cm 0.2cm, clip=True, scale=0.48]{figs/cluster_catalog_mass63.pdf} 
      \end{array}$
   \end{center}
...
\begin{figure}[ht!]
   \begin{center}$
      \begin{array}{cc}
         \includegraphics[trim=1.3cm 0.2cm 3cm 0.2cm, clip=True, scale=0.42]{figs/cluster_catalog_av63.pdf} 
      \end{array}$
   \end{center}
...
\begin{figure}[ht!]
   \begin{center}$
      \begin{array}{cc}
         \includegraphics[trim=6.2cm 0.2cm 0.2cm 0.2cm, clip=True, scale=0.75]{figs/all_dist.pdf} 
      \end{array}$
   \end{center}
...
\begin{figure*}[!htbp]
   \begin{center}$
      \begin{array}{cc}
         \includegraphics[trim=0.3cm 4.8cm 0.2cm 0.2cm, clip=True, scale=0.63]{figs/age_dist_all.pdf} 
      \end{array}$
   \end{center}
...
\begin{figure*}[!htbp]
   \begin{center}$
      \begin{array}{cc}
         \includegraphics[trim=0.3cm 3cm 7cm 0.2cm, clip=True, scale=0.65]{figs/mass_dist_all.pdf} 
      \end{array}$
   \end{center}
...
\begin{figure}[ht!]
   \begin{center}$
      \begin{array}{cc}
         \includegraphics[trim=6.2cm 0.2cm 0.2cm 0.2cm, clip=True, scale=0.75]{figs/int_dist.pdf} 
      \end{array}$
   \end{center}
...
\begin{figure*}[!htbp]
   \begin{center}$
      \begin{array}{cc}
         \includegraphics[trim=0.3cm 4.8cm 0.2cm 0.2cm, clip=True, scale=0.63]{figs/age_dist_int.pdf} 
      \end{array}$
   \end{center}
...
\begin{figure*}[!htbp]
   \begin{center}$
      \begin{array}{cc}
         \includegraphics[trim=0.3cm 3cm 7cm 0.2cm, clip=True, scale=0.65]{figs/mass_dist_int.pdf} 
      \end{array}$
   \end{center}
...
\begin{figure}[ht!]
   \begin{center}$
      \begin{array}{cc}
         \includegraphics[trim=1.5cm 0cm 1cm 3cm, clip=True, scale=0.4]{figs/int_diff62.pdf} 
      \end{array}$
   \end{center}
